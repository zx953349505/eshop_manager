				...
				<div class="block">
					...
					<div id="page-filter" class="block-body collapse in">
						<div class="search-well">
							<form  class="form-inline" role="search" action="${pageContext.request.contextPath }/question/select_questionlist" method="post">
					...
					<div id="page-filter" class="block-body collapse in">
						<div class="search-well">
							<form  class="form-inline" role="search" action="${pageContext.request.contextPath }/question/addquestion" method="post">
										...
										<tr>
											...
											<td>
												<a href="${pageContext.request.contextPath }/user/updateinfo?userId=" title="编辑"><i class="icon-pencil"></i></a>
	              								<a href="${pageContext.request.contextPath }/question/deletequestion?question_id=${qu.question_id }" title="删除"><i class="icon-remove"></i></a>
											</td>
										</tr>
