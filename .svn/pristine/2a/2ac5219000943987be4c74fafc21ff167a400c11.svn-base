...
<html lang="en">
  <head>
	...
	<script src="${pageContext.request.contextPath }/static/lib/addbook.js" type="text/javascript"></script>
		...
		<div class="container-fluid">
			...
			<div class="row-fluid">
				...
				<div class="well">
					...
					<!-- 通用信息 -->
					<form id="uploadForm" action="${pageContext.request.contextPath }/book/addbook.action" method="post"  enctype="multipart/form-data">
