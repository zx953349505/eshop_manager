					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active in" id="basicInfo">
							<form id="uploadForm" enctype="multipart/form-data">
								...
								<label>密码</label>
								<input type="text" name="user_pwd" class="input-xlarge"> 
								
								<label>邮箱</label> 
								<input type="text" name="user_email" class="input-xlarge">
								
								<label>性别</label> 
								<input type="text" name="user_sex" class="input-xlarge"> 
								
								<label>电话</label> 
								<input type="text" name="user_phone" class="input-xlarge">
								...
								<label>密保答案</label>
					            <input type="text" name="question_answer"  class="input-xlarge"/>
				                ...
				                <label>详细地址</label>
				                <div class="wlfg-wrap">
									<input type="text" name="user_address" class="rlf-input" placeholder="请输入详细地址" value="${sessionScope.userInfo.user_address }" />
				                </div>
